...
# biblical_scripts documentation build
...
from biblical_scripts import __version__ as release

# -- Project information -----------------------------------------------------

project = "biblical_scripts"
copyright = "2020, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "biblical_scriptsdoc"
...
latex_documents = [
    (
        master_doc,
        "biblical_scripts.tex",
        "biblical_scripts Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "biblical_scripts",
        "Project biblical_scripts codebase.",
        "Data-Science",
    )
]
