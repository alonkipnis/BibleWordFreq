...
"""Project settings."""
from biblical_scripts.hooks import ProjectHooks
from biblical_scripts.debugging.pipeline_debug import PDBPipelineDebugHook

# Instantiate and list your project hooks here
HOOKS = (ProjectHooks(),PDBPipelineDebugHook(),)
